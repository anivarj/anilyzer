...
public class RunScript {
    public static void main(String... args) throws FileNotFoundException, ScriptException {
        ...
        ij.script().run(new File("/home/edward/Documents/Development/Repos/Other/run_jython_scripts_from_ide/src/main/jython/imagej_script.py"), false, new Object[]{"input", imp, "ij", ij});
